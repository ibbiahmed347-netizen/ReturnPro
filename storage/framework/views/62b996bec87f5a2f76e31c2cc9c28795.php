...
<div class="main-content">
    ...
    <div class="row g-4">
        <div class="col-md-4">
            <a href="<?php echo e(route('reports.collections')); ?>" class="report-card card d-block p-4">
        ...
        <div class="col-md-4">
            <a href="<?php echo e(route('reports.outstanding')); ?>" class="report-card card d-block p-4">
        ...
        <div class="col-md-4">
            <a href="<?php echo e(route('reports.expenses')); ?>" class="report-card card d-block p-4">
        ...
        <div class="col-md-4">
            <a href="<?php echo e(route('reports.client-wise')); ?>" class="report-card card d-block p-4">
        ...
        <div class="col-md-4">
            <a href="<?php echo e(route('reports.income-tax')); ?>" class="report-card card d-block p-4">
        ...
        <div class="col-md-4">
            <a href="<?php echo e(route('reports.sales-tax')); ?>" class="report-card card d-block p-4">
...
</html><?php /**PATH C:\xampp\htdocs\returnpro\resources\views/reports/index.blade.php ENDPATH**/ ?>