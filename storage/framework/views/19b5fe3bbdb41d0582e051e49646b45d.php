...
<div class="main-content">
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-3"><div class="card border-0 shadow-sm p-3 text-center"><div class="text-muted">Total Returns</div><h4 class="text-primary"><?php echo e($returns->count()); ?></h4></div></div>
        <div class="col-md-3"><div class="card border-0 shadow-sm p-3 text-center"><div class="text-muted">Total Sales</div><h4 class="text-info">Rs. <?php echo e(number_format($returns->sum('total_sales'), 0)); ?></h4></div></div>
        <div class="col-md-3"><div class="card border-0 shadow-sm p-3 text-center"><div class="text-muted">Output Tax</div><h4 class="text-warning">Rs. <?php echo e(number_format($returns->sum('total_sales_tax'), 0)); ?></h4></div></div>
        <div class="col-md-3"><div class="card border-0 shadow-sm p-3 text-center"><div class="text-muted">Tax Payable</div><h4 class="text-danger">Rs. <?php echo e(number_format($returns->sum('tax_payable'), 0)); ?></h4></div></div>
    </div>
        ...
        <div class="card-body p-0">
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo e($return->client->name); ?><br><small class="text-muted"><?php echo e($return->client->case_number ?? ''); ?></small></td>
                        <td><span class="badge bg-primary"><?php echo e($return->month_name); ?> <?php echo e($return->year); ?></span></td>
                        <td class="text-end">Rs. <?php echo e(number_format($return->total_sales, 0)); ?></td>
                        <td class="text-end">Rs. <?php echo e(number_format($return->total_sales_tax, 0)); ?></td>
                        <td class="text-end">Rs. <?php echo e(number_format($return->total_input_tax, 0)); ?></td>
                        <td class="text-end"><strong class="text-danger">Rs. <?php echo e(number_format($return->tax_payable, 0)); ?></strong></td>
                        <td><span class="badge bg-<?php echo e($return->status == 'Published' ? 'success' : 'warning'); ?>"><?php echo e($return->status); ?></span></td>
                    </tr>
                ...
                <tfoot class="table-dark">
                    <tr><td colspan="2"><strong>Total</strong></td><td class="text-end"><strong>Rs. <?php echo e(number_format($returns->sum('total_sales'), 0)); ?></strong></td><td class="text-end"><strong>Rs. <?php echo e(number_format($returns->sum('total_sales_tax'), 0)); ?></strong></td><td class="text-end"><strong>Rs. <?php echo e(number_format($returns->sum('total_input_tax'), 0)); ?></strong></td><td class="text-end"><strong>Rs. <?php echo e(number_format($returns->sum('tax_payable'), 0)); ?></strong></td><td></td></tr>
                </tfoot>
            </table>
        </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\returnpro\resources\views/reports/sales_tax.blade.php ENDPATH**/ ?>