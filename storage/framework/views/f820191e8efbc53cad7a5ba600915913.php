...
<div class="main-content">
    ...
    <div class="card border-0 shadow-sm mb-3 no-print">
        <div class="card-body">
            <form method="GET" class="row g-2">
                ...
                <div class="col-md-3"><input type="date" name="from_date" class="form-control" value="<?php echo e(request('from_date')); ?>" placeholder="From Date"></div>
                <div class="col-md-3"><input type="date" name="to_date" class="form-control" value="<?php echo e(request('to_date')); ?>" placeholder="To Date"></div>
    ...
    <div class="card border-0 shadow-sm mb-3" style="border-left: 4px solid #28a745 !important;">
        <div class="card-body py-2 d-flex justify-content-between align-items-center">
            ...
            <h4 class="mb-0 text-success">Rs. <?php echo e(number_format($totalAmount, 0)); ?></h4>
        </div>
    </div>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($receipt->voucher->voucher_no ?? '-'); ?></td>
                        <td><span class="badge bg-secondary"><?php echo e($receipt->payment_method); ?></span></td>
                        <td class="text-end"><strong>Rs. <?php echo e(number_format($receipt->amount, 0)); ?></strong></td>
                    </tr>
                ...
                <tfoot class="table-dark">
                    <tr><td colspan="5"><strong>Total</strong></td><td class="text-end"><strong>Rs. <?php echo e(number_format($totalAmount, 0)); ?></strong></td></tr>
                </tfoot>
            </table>
        </div>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\returnpro\resources\views/reports/collections.blade.php ENDPATH**/ ?>