...
<div class="sidebar">
    ...
    <nav class="mt-2">
        ...
        <a href="<?php echo e(route('tasks.index')); ?>" class="nav-link active"><i class="fas fa-tasks"></i> Tasks</a>
    ...
    <div class="card border-0 shadow-sm mb-3">
        <div class="card-body">
            <form method="GET" class="row g-2">
                <div class="col-md-3">
                    <input type="text" name="search" class="form-control" placeholder="Search by title or client..." value="<?php echo e(request('search')); ?>">
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <a href="<?php echo e(route('tasks.create')); ?>" class="btn btn-success w-100"><i class="fas fa-plus"></i> Add Task</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="card-body p-0">
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <?php $overdue = $task->due_date && $task->due_date < now()->toDateString() && $task->status != 'Completed'; ?>
                    <tr class="<?php echo e($overdue ? 'overdue' : ''); ?>">
                        <!-- <td>
                            <?php echo e($task->title); ?>

                            <?php if($overdue): ?><span class="badge bg-danger ms-1">Overdue</span><?php endif; ?>
                            <?php if($task->description): ?><br><small class="text-muted"><?php echo e(Str::limit($task->description, 50)); ?></small><?php endif; ?>
                        </td>-->
                        <td>
                            <?php if($task->status != 'Completed'): ?>
                            <form method="POST" action="<?php echo e(route('tasks.update', $task)); ?>" class="d-inline">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo e(route('tasks.edit', $task)); ?>" class="btn btn-sm btn-warning text-white"><i class="fas fa-edit"></i></a>
                            <form method="POST" action="<?php echo e(route('tasks.destroy', $task)); ?>" class="d-inline" onsubmit="return confirm('Delete this task?')">
                                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                <button type="submit" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></button>
                            </form>
                        </td>
                        <td><?php echo e($task->client->name ?? '-'); ?><br><small class="text-muted"><?php echo e($task->client->case_number ?? ''); ?></small></td>
                        <td><?php echo e($task->assignedTo->name ?? 'Unassigned'); ?></td>
                        <td><?php echo e($task->due_date ?? '-'); ?></td>
                        <td><span class="badge bg-<?php echo e($task->priority_color); ?>"><?php echo e($task->priority); ?></span></td>
                        <td><span class="badge bg-<?php echo e($task->status_color); ?>"><?php echo e($task->status); ?></span></td>
                        <td>
                            <a href="<?php echo e(route('tasks.edit', $task)); ?>" class="btn btn-sm btn-warning text-white"><i class="fas fa-edit"></i></a>
                            <form method="POST" action="<?php echo e(route('tasks.destroy', $task)); ?>" class="d-inline" onsubmit="return confirm('Delete this task?')">
                                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                    ...
                    <tr><td colspan="7" class="text-center text-muted py-4"><i class="fas fa-tasks fa-2x mb-2 d-block"></i>No tasks found. <a href="<?php echo e(route('tasks.create')); ?>">Add first task</a></td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
        <?php if($tasks->hasPages()): ?><div class="card-footer"><?php echo e($tasks->appends(request()->query())->links()); ?></div><?php endif; ?>
    </div>
</div>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
</body>
</html><?php /**PATH C:\xampp\htdocs\returnpro\resources\views/tasks/index.blade.php ENDPATH**/ ?>